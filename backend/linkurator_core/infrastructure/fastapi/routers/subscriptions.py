...
def get_router(  # pylint: disable=too-many-statements
    ...
    async def get_followed_subscriptions_items(
            request: Request,
        ...
        """
        Get items from all followed subscriptions sorted by published date. Newer items first.
        ...
        response = await get_followed_subscriptions_items_handler.handle(
        ...
        return Page[ItemSchema].create(
            elements=[
                ItemSchema.from_domain_item(
                    ...
                    user_interactions=item_with_sub.interactions,
                )
        ...
        return Page[ItemSchema].create(
            elements=[
                ItemSchema.from_domain_item(
                    ...
                    user_interactions=item_with_interactions.interactions,
                    curator_interactions=item_with_interactions.curator_interactions,
                )
