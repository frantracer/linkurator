...
async def main() -> None:
    ...
    access_token = await google_account_service.generate_access_token_from_refresh_token(refresh_token)

    if access_token is not None:
        await google_account_service.get_user_info(access_token)
    else:
        pass
